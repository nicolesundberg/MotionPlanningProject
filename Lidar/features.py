...
class featureDetection:
    def __init__(self):
        ...
        self.PR = 0 #number of laser points contained in line seg
    ...
    #assumes lines definitely intersect
    ...
    def odr_fit(self, laser_points):
        ...
        #create realdata object using intiiated data from above
        data = RealData(x, y)
    ...
    def seed_segment_growing(self, indices, break_point):
        ...
        while self.dist_point2line(line_eq, self.LASERPOINTS[PB][0]):
            if PB < break_point:
                ...
                m, b = self.odr_fit(self.LASERPOINTS[PB:PF])
                line_dq = self.lineForm_SI2G(m, b)
